...
## Corpus Check
- 309 files · ~224,713 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2103 nodes · 4049 edges · 227 communities (124 shown, 103 thin omitted)
...
## Communities (227 total, 103 thin omitted)

### Community 0 - "event-generator.ts"
Cohesion: 0.17
Nodes (13): kinematicsForSubtype(), profileCruise(), profileMid(), categoryFallbackProfile(), profile(), resolveGenerationCruiseKnots(), resolveVehicleProfile(), EXPECTED_SUBTYPES (+5 more)
...
Cohesion: 0.08
Nodes (47): ARTERIAL_CLASSES, astarRoad(), BLOCKED_ACCESS, buildRoadGraph(), CLASS_SPEED_MPS, classPreferenceMultiplier(), cumulativeDistances(), DRIVABLE_CLASSES (+39 more)

### Community 3 - "map-data-provider.tsx"
Cohesion: 0.17
Nodes (19): EventIngestTable(), eventPayloadBadges(), eventSummary(), IntelligenceMessagesTable(), VirtualizedTableShell(), addPriorityTerm(), isPriorityMessage(), matchPriorityTerms() (+11 more)
...
Cohesion: 0.13
Nodes (17): BrandMark(), Header(), ModeToggle(), OperationsDashboard(), useSimulation(), DropdownMenu(), DropdownMenuCheckboxItem(), DropdownMenuContent() (+9 more)
...
Cohesion: 0.11
Nodes (26): matchesTargetSearch(), TargetRoster(), targetSearchFields(), TrackedTargetCard(), TrackingMap, getVehicleCategoryIcon(), Command(), CommandDialog() (+18 more)
...
Cohesion: 0.10
Nodes (39): assignTravelGroupIds(), atOffsetIso(), buildTravelPlans(), CALLSIGN_PREFIXES, clamp(), clampDemoLatitude(), createSyntheticDemoScenario(), defaultTargetProfile() (+31 more)

### Community 11 - "simulation-engine.ts"
Cohesion: 0.27
Nodes (18): applyLatitudeBound(), assertFeasibleEndWindow(), CATEGORY_MOVEMENT_SMOOTHING, clamp(), clampLatitude(), distributeTimestamps(), generatePointToPointEvents(), generateRouteEvents() (+10 more)
...
Cohesion: 0.19
Nodes (9): DEFAULT_POSITION, EditTimelineEventProps, TimelineEventShell(), TimelineEventShellProps, ViewTimelineEventProps, ValidationIssue, Badge(), badgeVariants (+1 more)
...
Cohesion: 0.09
Nodes (30): DemoRegionSelect(), formatRegionSupports(), incompatibleRegionCategories(), FieldErrors, GenerateRandomRouteForm(), validateRandomForm(), FieldErrors, isValidCoordinate() (+22 more)
...
Cohesion: 0.26
Nodes (14): demoRegionById(), kinematicsFromProfile(), unpackGeoSeedsAerodromes(), clamp(), loadDefaultAerodromes(), planTargetRouteEvents(), PlanTargetRouteEventsOptions, PlanTargetRouteEventsResult (+6 more)

### Community 27 - "input-group.tsx"
Cohesion: 0.07
Nodes (40): EventMessageExportDialog(), MapLocationPicker, PreviewEventGraph, TrackingMap, countPayloadStats(), getTocItemOffset(), SCHEMA_TOC_ITEMS, SchemaBreakdown() (+32 more)
...
Cohesion: 0.12
Nodes (21): TimedEventEdgeView(), EventGraphNodeView(), KIND_BADGE, KIND_COLOR, KIND_LABEL, edgeTypes, nodeTypes, PreviewEventGraphCanvas() (+13 more)
...
Cohesion: 0.20
Nodes (9): defaultEndPoint(), GenerateRouteForm(), categoryCruiseMidpointKnots(), deriveEndAtFromDistance(), SCHEMA_CONSTRAINTS, SCHEMA_DOC_SECTIONS, SchemaDocSection, TARGET_STATUSES (+1 more)
...
Cohesion: 0.06
Nodes (63): useMapData(), buildNeighborCollection(), buildTrailCollection(), createCompanionPointElement(), createEventPointElement(), ensureLineLayer(), ensureOverlayLayers(), findTimeNeighbors() (+55 more)

### Community 40 - "clsx"
Cohesion: 0.23
Nodes (18): blankScenario(), focusElementById(), ScenarioBuilder(), clampPreviewTimeMs(), computePreviewRevision(), getPreviewRangeMs(), getPreviewStartMs(), fieldHasIssue() (+10 more)

### Community 41 - "attachment.tsx"
Cohesion: 0.11
Nodes (31): CreateDemoScenarioOptions, CreateDemoScenarioResult, DemoTravelPlan, mergeGeneratedEvents(), createSeededIdFactory(), createSeededRandom(), resolveIdFactory(), buildSyntheticReady() (+23 more)
...
Cohesion: 0.19
Nodes (17): GenerateRandomRouteFormProps, GenerateRouteFormProps, PreviewEventGraphProps, buildEventGraph(), BuildEventGraphInput, EventGraphNodeData, EventPlaybackState, formatEventDeltaMs() (+9 more)

### Community 58 - "event-message-export.ts"
Cohesion: 0.16
Nodes (15): EditTimelineEvent(), issuesForField(), DEFAULT_EVENT_MESSAGE_EXPORT_OPTIONS, downloadEventMessages(), EventMessageExportOptions, formatEventMessages(), formatLatitude(), formatLongitude() (+7 more)
...
Cohesion: 0.15
Nodes (20): SimulationContext, SimulationContextValue, appearTarget(), applyEvent(), createInitialTargetStates(), createRuntime(), getNextEvent(), maskedProfile() (+12 more)

### Community 61 - "VehicleCategory"
Cohesion: 0.16
Nodes (15): DemoRegionSelectProps, matchingDemoLocationName(), MapTargetDisplay, CATEGORY_SET, DEMO_REGIONS, DemoRegion, demoRegionsByIds(), parseRegions() (+7 more)
...
### Community 183 - "cmdk"
Cohesion: 0.15
Nodes (20): acceptsCategory(), classifyPoint(), ClassifyPointOptions, closestPointOnSegment(), DRIVABLE_ROAD, haversineMeters(), NAVIGABLE_WATER_CLASSES, NavigableWaterClass (+12 more)
...
### Community 200 - "clsx"
Cohesion: 0.15
Nodes (27): arrivalBearingDeg(), cruiseAltitudeForDistance(), departureBearingDeg(), altitudeAlongPath(), assertFeasiblePathWindow(), categoryCeilingKnots(), clamp(), dedupePath() (+19 more)

### Community 205 - "map-location-picker.tsx"
Cohesion: 0.10
Nodes (28): createDemoScenario(), parseDemoTargetCount(), FIXTURE_DIR, loadFixtureSource(), ManifestEntry, seededRandom(), loadFixtureSource(), loadManifest() (+20 more)

### Community 211 - "simulation-idb-storage.ts"
Cohesion: 0.06
Nodes (59): SimulationProvider(), isLegacyScenario(), mergeProfile(), migrateRetiredVehicleCategories(), migrateScenarioV1ToV2(), migrateVehicleCategory(), legacy, VEHICLE_CATEGORY_SET (+51 more)

### Community 212 - "event-draft.ts"
Cohesion: 0.24
Nodes (12): MapLocationPickerProps, createDraftForTargetChange(), createEventDraft(), createFollowOnDraft(), DEFAULT_EVENT_POSITION, draftFromEvent(), EventDraft, eventFromDraft() (+4 more)
...
Cohesion: 0.27
Nodes (10): describeEvent(), ViewTimelineEvent(), FlatItem, GroupedTimeline(), HeaderItem, TargetHeaderBar(), derivePositionSnapshot(), hasEventPayload() (+2 more)
...
- **Why does `cn()` connect `cn` to `map-data-provider.tsx`, `simulation-storage.ts`, `tracking-map.tsx`, `simulation-import.tsx`, `clsx`, `target.ts`, `button.tsx`, `@base-ui/react`, `target.ts`, `@mapbox/vector-tile`, `fake-indexeddb`, `input-group.tsx`, `build-event-graph.ts`, `next-themes`, `bubble.tsx`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `haversineMeters()` connect `cmdk` to `map-styles.ts`, `map-location-picker.tsx`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `SimulationEvent` connect `SimulationEvent` to `map-data-provider.tsx`, `attachment.tsx`, `clsx`, `clsx`, `position-telemetry.ts`, `simulation-engine.ts`, `attachment.tsx`, `target.ts`, `button.tsx`, `simulation-idb-storage.ts`, `event-draft.ts`, `@mapbox/vector-tile`, `event-message-export.ts`, `input-group.tsx`, `ui/src/lib/utils.ts`, `build-event-graph.ts`?**
